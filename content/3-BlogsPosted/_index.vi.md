...
###  [Blog 1 - GIÁM SÁT HỆ THỐNG TRÊN AWS: ĐƯA CLOUDWATCH METRICS VÀO OPENTELEMETRY COLLECTOR TRONG VPC BẰNG LAMBDA](vi/3-blogsposted/3.1-blog1/)
...
###  [Blog 2 - KINH NGHIỆM THỰC CHIẾN: XÂY DỰNG AI GATEWAY QUẢN TRỊ AMAZON BEDROCK BẰNG API GATEWAY](vi/3-blogsposted/3.2-blog2/)
...
###  [Blog 3 - MỘT TÍNH NĂNG KHÁ LIÊN QUAN CỦA AWS LAKE FORMATION](vi/3-blogsposted/3.3-blog3/)
